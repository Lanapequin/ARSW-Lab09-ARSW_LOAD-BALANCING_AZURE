...
1. **Balanceadores de Carga de Azure, SKU e IP Pública**
   ...
   **Qué es SKU, qué tipos hay y en qué se diferencian**  
   ...
   | Estándar                     | Alto rendimiento y latencia ultrabaja. Tráfico de capa de red. Alta resistencia. | Basado en IP o NIC   | Compatible (redundancia de zona o zonal)   | Cerrado a conexiones entrantes por defecto; requiere NSG para permitir tráfico (Microsoft, n.d.-b, “Comparación de SKU”)                               |
